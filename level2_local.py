...
if __name__ == '__main__':
    ...
    leftbox_group.draw(screen)
    rightbox_group.draw(screen)
    topleftbox_group.draw(screen)
    topleftbox1_group.draw(screen)
    topleftbox2_group.draw(screen)
    topleftbox3_group.draw(screen)
    topleftbox4_group.draw(screen)
    pygame.display.flip()
